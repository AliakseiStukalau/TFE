...
AHouse::AHouse()
{
	...
	ConstructorHelpers::FObjectFinder<UStaticMesh> objWallDoorOpposite(TEXT("StaticMesh'/Game/Meshes/House/Wall_400x300.Wall_400x300'"));
	ConstructorHelpers::FObjectFinder<UStaticMesh> objWallWindowOpposite(TEXT("StaticMesh'/Game/Meshes/House/Wall_400x300.Wall_400x300'"));
	ConstructorHelpers::FObjectFinder<UStaticMesh> objWallWindow(TEXT("StaticMesh'/Game/Meshes/House/Wall_Window_400x300.Wall_Window_400x300'"));
	ConstructorHelpers::FObjectFinder<UStaticMesh> objWallDoor(TEXT("StaticMesh'/Game/Meshes/House/Wall_Door_400x300.Wall_Door_400x300'"));
	ConstructorHelpers::FObjectFinder<UStaticMesh> objRoof(TEXT("StaticMesh'/Game/Meshes/House/Wall_400x400.Wall_400x400'"));
