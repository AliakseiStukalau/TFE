...
AAxe::AAxe()
{
    ...
    const ConstructorHelpers::FObjectFinder<UMaterial> material0(TEXT("Material'/Game/Materials/Master_Material/Battle_Axe/01___Default.01___Default'"));
    const ConstructorHelpers::FObjectFinder<UStaticMesh> asset0(TEXT("StaticMesh'/Game/Meshes/Decorative_Battle_Axe/axe_mesh_0.axe_mesh_0'"));
    ...
    const ConstructorHelpers::FObjectFinder<UMaterial> material1(TEXT("Material'/Game/Materials/Master_Material/Battle_Axe/01___Default__1.01___Default__1'"));
    const ConstructorHelpers::FObjectFinder<UStaticMesh> asset1(TEXT("StaticMesh'/Game/Meshes/Decorative_Battle_Axe/axe_mesh_1.axe_mesh_1'"));
    ...
    const ConstructorHelpers::FObjectFinder<UMaterial> material2(TEXT("Material'/Game/Materials/Master_Material/Battle_Axe/01___Default__1.01___Default__1'"));
    const ConstructorHelpers::FObjectFinder<UStaticMesh> asset2(TEXT("StaticMesh'/Game/Meshes/Decorative_Battle_Axe/axe_mesh_2.axe_mesh_2'"));
